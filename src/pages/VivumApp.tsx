          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4 animate-slide-in-right">
              <Card className="bg-muted/30 p-6 flex flex-col items-center text-center">
                ...
                <p className="text-sm text-muted-foreground">Comprehensive exploration of existing research</p>
              </Card>
              
              <Card className="bg-muted/30 p-6 flex flex-col items-center text-center">
                <Database className="h-10 w-10 text-primary mb-4" />
                <h3 className="font-bold mb-2">Data Extraction</h3>
                <p className="text-sm text-muted-foreground">Systematic collection of relevant information</p>
              </Card>
              
              <Card className="bg-muted/30 p-6 flex flex-col items-center text-center">
                <BarChart className="h-10 w-10 text-primary mb-4" />
                <h3 className="font-bold mb-2">Analysis</h3>
                <p className="text-sm text-muted-foreground">Critical evaluation of collected evidence</p>
              </Card>
              
              <Card className="bg-muted/30 p-6 flex flex-col items-center text-center">
                <Share2 className="h-10 w-10 text-primary mb-4" />
                <h3 className="font-bold mb-2">Integration</h3>
                <p className="text-sm text-muted-foreground">Synthesis of findings into cohesive insights</p>
              </Card>
            </div>
          </div>
        </div>
